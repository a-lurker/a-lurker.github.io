...
1. rapidjson -- very rapid
2. cjson -- at least 10x faster than the openLuup module
...
It's highly recommended to have rapidjson or cjson be made available on the host device.
...
Raspberry Pi typically have the cjson module installed already.
